...
const Header = () => {
  return (
    <div class="header" className="header">
      <Title />
      {/* <h1>Food villa</h1> */}
      <div className="nav-items" class="nav-items">
        <ul>
          <li>Home</li>
          <li>About</li>
          <li>Contact</li>
...
const root = ReactDOM.createRoot(document.getElementById("root")); //Here we created a root element in react  //we will use ReactDOM because we will modify DOM. This library is used when you want to manipulate the HTML element

root.render(<AppLayout />); //this render method takes in the react element and modifies our dom and its inject it into the dom.
